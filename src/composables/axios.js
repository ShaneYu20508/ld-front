...
// 請求送出之前，執行者個 function
// config 代表這次請求的設定
// 1. 呼叫 axios.get / axios.post 時
// 2. interceptors.request 請求的攔截器(處理資料)
// 3. 送出請求
// 4. interceptors.response 回應的攔截器(處理資料)
// 5. 呼叫的地方的 .then() .catch()
...
// 3. 傳送舊換新請求
// 3-1. 如果舊換新成功，修改 apiAuth.get('/users/me) 的 jwt 為新的，之後送出
